...
function Footer() {
  return (
    <div className="footer">
      <a href="https://twitter.com/ikennarichard_" aria-label="social" className="social">
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 512 512"><path fill="currentColor" d="M389.2 48h70.6L305.6 224.2L487 464H345L233.7 318.6L106.5 464H35.8l164.9-188.5L26.8 48h145.6l100.5 132.9zm-24.8 373.8h39.1L151.1 88h-42z" /></svg>
      </a>
      <a href="https://linkedin.com/in/ikenna-richard" aria-label="social" className="social">
      ...
      <a href="https://github.com/ikennarichard" aria-label="social">
